...
movie.o: movie.cpp movie.h util.h product.h product_parser.h
	$(CXX) $(CXXFLAGS) $(DEFS) -o $@ -c movie.cpp
book.o: book.cpp book.h util.h product.h product_parser.h
	$(CXX) $(CXXFLAGS) $(DEFS) -o $@ -c book.cpp
clothing.o: clothing.cpp clothing.h util.h product.h product_parser.h
